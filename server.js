...
const requestCounts = new NodeCache({ stdTTL: config.rateLimitWindowMs / 60 }); // TTL in seconds
...
app.use((req, res, next) => {
    ...
    requestCounts.set(ip, count + 1, config.rateLimitWindowMs / 60); // Reset TTL on each access
